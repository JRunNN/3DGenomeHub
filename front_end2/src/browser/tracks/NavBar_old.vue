<template>
    <div class="mb-8 bg-white relative flex rounded-lg items-center md:w-auto md:flex-row md:space-y-0 md:items-center md:space-x-3">
        <!-- assembly selection -->
...
const emit = defineEmits(['update:chrom', 'update:start', 'update:end', 'update:min', 'update:max', 'shift', 'zoomIn', 'zoomOut', 'zoomTo'])
const asm = props.asm

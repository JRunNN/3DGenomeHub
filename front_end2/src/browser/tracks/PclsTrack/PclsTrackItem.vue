...
onMounted(() => {
    ...
    //     showSpin.value = true
    //     fetchCurvFileData(url).then(d => {
    //         console.log(d)
    //         console.log(chrom.value, start.value, end.value)

    //         filterData(d);
    //         console.log('filterData', filteredData.value)
    //         filteredData.value = _preprocess(filteredData.value, chrom.value)
    //         console.log('filterData', filteredData.value)

    //         filteredData.value = _sortItems(filteredData.value, start.value, end.value, { chrom: chrom.value, start: start.value, end: end.value });
    //         console.log('filterData', filteredData.value)

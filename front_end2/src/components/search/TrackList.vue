<template>
  ...
  <div v-if="isLoaded " :id="props.sessionId" ref="trackList"
       class="track-list flex flex-col  transition-all duration-100	"
       :class="{'w-full h-full': isOpen, 'w-full h-16 overflow-hidden': !isOpen}"
       >
    <nav-bar v-model:chrom="corenavStore.chrom" :asm="corenavStore.asm" :chromNames="chromNames"
             :chromSizes="chromSizes" :end="corenavStore.end" :max="corenavStore.max" :min="corenavStore.min"
             :start="corenavStore.start" @shift="shift" @zoomIn="zoomIn" @zoomOut="zoomOut" @zoomTo="zoomTo" @toggleGenomicRegionPanel="hanleIsOpen" >
    </nav-bar>
    <chrom-view :chrom="corenavStore.chrom" :chromBands="chromBands" :chromNames="chromNames" :chromSizes="chromSizes"
                :end="corenavStore.end" :isSelectorVisible="true" :labelWidth="0" :max="corenavStore.max"
                :min="corenavStore.min" :start="corenavStore.start" type="full" @zoomTo="zoomTo">
    </chrom-view>
    <template v-for="(trackComponent, index) in trackComponents">
      <track-item :data-id="trackComponent.key" :trackId="trackComponent.key">
        <template #trackTitle>
          <n-tag v-show="!isOutside" class="text">{{ trackComponent.trackConfig.name }}</n-tag>
        </template>
        <template #canvas>
        ...
        <template #controller>
          <component :is="trackComponent.trackConfig.controllerKey" v-if="trackComponent.trackConfig.controllerKey"
                     :key="index" :controllerConfig="trackComponent.controllerConfig"
...
import ChromView from "@/browser/tracks/ChromView.vue";
...
const {isOutside} = useMouseInElement(trackList.value)
...
// const sessionStore = useSessionStore()
// const tracksOrder = sessionStore.getSessionList.filter(session => session.key === props.sessionId)[0].trackIds
//
...
const newTrack1 = {
  ...
  "key": "cee9f7cc-2faa-4025-8513-3cc0e36d9f64",
  "trackConfig": {
    "key": "CurvTrack",
    "chartKey": "CurvTrack",
    "conKey": "CurvTrackConfig",
    "name": "GM12878_bedpe_curve",
    "label": "GM12878_bedpe_curve",
    "image": "line.png",
    "sessionId": [
      "30161afb-cb5a-4b09-933d-5ea13b903a96"
    ],
    "url": ""
  },
  "option": {
    ...
    "url": "http://localhost:8000/data/ENCFF379AWZ.bedpe",
    "series": [
      {
        "type": "line",
        "lineStyle": {
...
//     "h": 160
//   },
//   "key": "5f519865-0d70-409f-aba7-8660c05beaa2",
//   "trackConfig": {
//     "key": "HicTrack",
//     "chartKey": "HicTrack",
//     "conKey": "HicTrackConfig",
//     "name": "GM12878_hic",
//     "label": "GM12878_hic",
//     "image": "line.png",
//     "sessionId": [
...
//       }
//     },
//     "url": "http://localhost:8000/data/ENCFF379AWZ.hic",
//     "series": [
//       {
//         "type": "segment",
//         "label": {
...
//     "h": 160
//   },
//   "key": "73603a1a-b8f8-4806-a001-7f79061ce39b",
//   "trackConfig": {
//     "key": "LineGTrack",
//     "chartKey": "LineGTrack",
//     "conKey": "LineGTrackConfig",
//     "name": "GM12878_bigwig",
//     "label": "GM12878_bigwig",
//     "image": "line.png",
//     "sessionId": [
//       "30161afb-cb5a-4b09-933d-5ea13b903a96"
//     ],
...
//     },
//     "url": [
//       "http://localhost:8000/data/ENCFF347QOE.bigWig"
//     ],
//     "series": [
//       {
//         "type": "bar",
...
//     "h": 160
//   },
//   "key": "7d0451e8-8172-474a-8c70-2fd388b8956a",
//   "trackConfig": {
//     "key": "PclsTrack",
//     "chartKey": "PclsTrack",
//     "conKey": "PclsTrackConfig",
//     "name": "GM12878_bedpe_clusters",
//     "label": "GM12878_bedpe_clusters",
//     "image": "line.png",
//     "sessionId": [
//       "30161afb-cb5a-4b09-933d-5ea13b903a96"
//     ],
...
//   }
// }
trackStore.addTrackList(newTrack1, false, true);
// trackStore.addTrackList(newTrack2, false, true);
// trackStore.addTrackList(newTrack3, false, true);
// trackStore.addTrackList(newTrack4, false, true);

const newSession = {
  "key": "30161afb-cb5a-4b09-933d-5ea13b903a96",
  "trackIds": [
    "cee9f7cc-2faa-4025-8513-3cc0e36d9f64",
    "5f519865-0d70-409f-aba7-8660c05beaa2",
    "73603a1a-b8f8-4806-a001-7f79061ce39b",
    "7d0451e8-8172-474a-8c70-2fd388b8956a"
  ],
  "sessionConfig": {
    "type": "TrackList",
    "maxTrackNum": 10
...
const sessionUuid = newSession.key
...
const trackComponents = [ {
  ...
  "trackConfig": {
    ...
    "label": "GM12878_bedpe_curve",
    "image": "line.png",
    "sessionId": ["30161afb-cb5a-4b09-933d-5ea13b903a96"],
    "url": ""
  },
  "option": {
    ...
    "series": [{
      "type": "line",
      "lineStyle": {"type": "solid", "width": 3, "color": "#EBE5DA"},
      "areaStyle": {"opacity": 0.4, "color": "#CF625F"}
    }],
    "backgroundColor": "rgba(0,0,0,0)"
  }
}]
...
onMounted(() => {
  ...
  watch(() => isLoaded.value, async (newValue) => {
    if (newValue) {
      ...
      //初始化
      var sortable = Sortable.create(trackList.value, ops);
    }
  })

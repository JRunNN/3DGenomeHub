...
// import {downloadFile} from './FileDownload.ts'

const trackStore = useTrackStore();
const sessionStore = useSessionStore();
const route = useRoute()
const cell_id = route.params.id
console.log(cell_id)
// route.params
//
// const TrackList = defineAsyncComponent(() =>
//   import('@/browser/elements/TrackList.vue')
// )
let asm = {
  label: 'hg38',
  chromSizes: {
...
const geneAnnoInfo = [{
  id: 'hg38-ucsc-gene-annotation-2',
...
const fnGetChromatinLoops = (params) => {
  loadingRef.value = true
  axios.get(import.meta.env.VITE_BASE_URL + '/search/chromloops', {
    responseType: 'json',
    params: params,
    paramsSerializer: {
      indexes: null

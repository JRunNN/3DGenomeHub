...
var BgzipIndexedFasta = /** @class */ (function (_super) {
    ...
    function BgzipIndexedFasta(_a) {
        var fasta = _a.fasta, path = _a.path, fai = _a.fai, faiPath = _a.faiPath, gzi = _a.gzi, gziPath = _a.gziPath;
        var _this = _super.call(this, { fasta: fasta, path: path, fai: fai, faiPath: faiPath }) || this;
        if (fasta && gzi) {

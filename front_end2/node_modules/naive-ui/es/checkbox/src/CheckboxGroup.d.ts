import { type PropType, type Ref, type ComputedRef } from 'vue';
...
declare const _default: import("vue").DefineComponent<{
    ...
    readonly 'onUpdate:value': PropType<MaybeArray<(value: (string | number)[], meta: {
        actionType: "check" | "uncheck";
        value: string | number;
    }) => void>>;
    readonly onUpdateValue: PropType<MaybeArray<(value: (string | number)[], meta: {
        actionType: "check" | "uncheck";
        value: string | number;
    }) => void>>;
    readonly onChange: PropType<MaybeArray<(value: (string | number)[]) => void> | undefined>;
}, {

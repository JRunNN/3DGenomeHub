...
import type { ArrowScopedSlotProps, DotScopedSlotProps, Size } from 'naive-ui/es/carousel/src/interface';
...
export declare const carouselProps: {
    ...
    theme: PropType<import("naive-ui/es/_mixins").Theme<"Carousel", {
        dotSize: string;
        dotColor: string;
    ...
    themeOverrides: PropType<import("naive-ui/es/_mixins/use-theme").ExtractThemeOverrides<import("naive-ui/es/_mixins").Theme<"Carousel", {
        dotSize: string;
        dotColor: string;
        dotColorActive: string;
        dotColorFocus: string;
    ...
    builtinThemeOverrides: PropType<import("naive-ui/es/_mixins/use-theme").ExtractThemeOverrides<import("naive-ui/es/_mixins").Theme<"Carousel", {
        dotSize: string;
        dotColor: string;
        dotColorActive: string;
        dotColorFocus: string;

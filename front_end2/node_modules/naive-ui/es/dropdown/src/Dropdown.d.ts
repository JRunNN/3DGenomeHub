...
import { type MaybeArray, type ExtractPublicPropTypes } from 'naive-ui/es/_utils';
import type { DropdownMixedOption, OnUpdateValue, OnUpdateValueImpl, RenderLabel, RenderIcon, RenderLabelImpl, RenderIconImpl, RenderOption, NodeProps, RenderOptionImpl, DropdownMenuProps } from 'naive-ui/es/dropdown/src/interface';
...
export declare const dropdownProps: {
    readonly theme: PropType<import("naive-ui/es/_mixins").Theme<"Dropdown", {
    ...
    readonly themeOverrides: PropType<import("naive-ui/es/_mixins/use-theme").ExtractThemeOverrides<import("naive-ui/es/_mixins").Theme<"Dropdown", {
        optionHeightSmall: string;
        optionHeightMedium: string;
        optionHeightLarge: string;
        optionHeightHuge: string;
    ...
    readonly builtinThemeOverrides: PropType<import("naive-ui/es/_mixins/use-theme").ExtractThemeOverrides<import("naive-ui/es/_mixins").Theme<"Dropdown", {
        optionHeightSmall: string;
        optionHeightMedium: string;
        optionHeightLarge: string;
        optionHeightHuge: string;
    ...
    readonly trigger: {
        type: PropType<import("naive-ui/es/popover").PopoverTrigger>;
        default: string;
    };
    readonly delay: {
...
declare const _default: import("vue").DefineComponent<{
    ...
    tmNodes: import("vue").ComputedRef<TreeNode<import("naive-ui").MenuOption | import("naive-ui/es/menu/src/interface").MenuRenderOption, import("naive-ui").MenuGroupOption, import("naive-ui/es/menu/src/interface").MenuIgnoredOption>[]>;
    ...
    readonly trigger: import("naive-ui/es/popover").PopoverTrigger;

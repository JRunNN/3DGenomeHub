...
export declare const sliderProps: {
    ...
    readonly theme: PropType<import("naive-ui/es/_mixins").Theme<"Slider", {
        fontSize: string;
        markFontSize: string;
        railColor: string;
    ...
    readonly themeOverrides: PropType<import("naive-ui/es/_mixins/use-theme").ExtractThemeOverrides<import("naive-ui/es/_mixins").Theme<"Slider", {
        fontSize: string;
        markFontSize: string;
        railColor: string;
        railColorHover: string;
    ...
    readonly builtinThemeOverrides: PropType<import("naive-ui/es/_mixins/use-theme").ExtractThemeOverrides<import("naive-ui/es/_mixins").Theme<"Slider", {
        fontSize: string;
        markFontSize: string;
        railColor: string;
        railColorHover: string;

...
export declare const logProps: {
    ...
    readonly theme: PropType<import("naive-ui/es/_mixins").Theme<"Log", {
        ...
        Code: import("naive-ui/es/_mixins").Theme<"Code", {
            textColor: string;
            fontSize: string;
    ...
    readonly themeOverrides: PropType<import("naive-ui/es/_mixins/use-theme").ExtractThemeOverrides<import("naive-ui/es/_mixins").Theme<"Log", {
        loaderFontSize: string;
        loaderTextColor: string;
        loaderColor: string;
        loaderBorder: string;
    ...
    readonly builtinThemeOverrides: PropType<import("naive-ui/es/_mixins/use-theme").ExtractThemeOverrides<import("naive-ui/es/_mixins").Theme<"Log", {
        loaderFontSize: string;
        loaderTextColor: string;
        loaderColor: string;
        loaderBorder: string;

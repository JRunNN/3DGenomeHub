...
import type { RateOnUpdateValue } from 'naive-ui/es/rate/src/interface';
export declare const rateProps: {
    ...
    readonly theme: PropType<import("naive-ui/es/_mixins").Theme<"Rate", {
        itemColor: string;
    ...
    readonly themeOverrides: PropType<import("naive-ui/es/_mixins/use-theme").ExtractThemeOverrides<import("naive-ui/es/_mixins").Theme<"Rate", {
        itemColor: string;
        itemColorActive: string;
        sizeSmall: string;
        sizeMedium: string;
    ...
    readonly builtinThemeOverrides: PropType<import("naive-ui/es/_mixins/use-theme").ExtractThemeOverrides<import("naive-ui/es/_mixins").Theme<"Rate", {
        itemColor: string;
        itemColorActive: string;
        sizeSmall: string;
        sizeMedium: string;

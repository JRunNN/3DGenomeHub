...
import type { MessageOptions, MessageType } from 'naive-ui/es/message/src/types';
...
export declare const messageProviderProps: {
    ...
    theme: PropType<import("naive-ui/es/_mixins").Theme<"Message", {
    ...
    themeOverrides: PropType<import("naive-ui/es/_mixins/use-theme").ExtractThemeOverrides<import("naive-ui/es/_mixins").Theme<"Message", {
        closeBorderRadius: string;
        textColor: string;
        textColorInfo: string;
        textColorSuccess: string;
    ...
    builtinThemeOverrides: PropType<import("naive-ui/es/_mixins/use-theme").ExtractThemeOverrides<import("naive-ui/es/_mixins").Theme<"Message", {
        closeBorderRadius: string;
        textColor: string;
        textColorInfo: string;
        textColorSuccess: string;

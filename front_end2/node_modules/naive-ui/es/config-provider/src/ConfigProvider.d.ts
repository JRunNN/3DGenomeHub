...
import type { NDateLocale } from 'naive-ui/es/locales';
import type { GlobalTheme, GlobalThemeOverrides, GlobalComponentConfig, GlobalIconConfig } from 'naive-ui/es/config-provider/src/interface';
import type { RtlProp, Breakpoints } from 'naive-ui/es/config-provider/src/internal-interface';

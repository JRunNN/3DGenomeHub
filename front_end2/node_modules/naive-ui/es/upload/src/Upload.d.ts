...
import type { ImageGroupProps } from 'naive-ui/es/image';
import type { FileInfo, FuncOrRecordOrUndef, OnFinish, OnRemove, OnDownload, OnChange, OnUpdateFileList, OnBeforeUpload, ListType, OnPreview, CreateThumbnailUrl, CustomRequest, OnError, SettledFileInfo, ShouldUseThumbnailUrl, RenderIcon } from 'naive-ui/es/upload/src/interface';

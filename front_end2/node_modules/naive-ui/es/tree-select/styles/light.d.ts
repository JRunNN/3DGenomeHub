...
declare const treeSelectLight: import("naive-ui/es/_mixins/use-theme").Theme<"TreeSelect", {
    menuPadding: string;
    menuColor: string;
    menuBoxShadow: string;
    menuBorderRadius: string;
    ...
    Tree: import("naive-ui/es/_mixins/use-theme").Theme<"Tree", {
        fontSize: string;
        ...
        Checkbox: import("naive-ui/es/_mixins/use-theme").Theme<"Checkbox", {
        ...
        Empty: import("naive-ui/es/_mixins/use-theme").Theme<"Empty", {
            fontSizeSmall: string;
            fontSizeMedium: string;
            fontSizeLarge: string;
            fontSizeHuge: string;
    ...
    InternalSelection: import("naive-ui/es/_mixins/use-theme").Theme<"InternalSelection", {
        fontSizeTiny: string;
        fontSizeSmall: string;
        fontSizeMedium: string;
        fontSizeLarge: string;

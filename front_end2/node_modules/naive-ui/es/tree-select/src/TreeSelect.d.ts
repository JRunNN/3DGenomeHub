...
import { type Key, type TreeOption } from 'naive-ui/es/tree/src/interface';
import type { SelectBaseOption, SelectOption } from 'naive-ui/es/select/src/interface';
import { type ExtractPublicPropTypes, type MaybeArray } from 'naive-ui/es/_utils';
import type { OnUpdateValue, TreeSelectNodeProps, TreeSelectOption, TreeSelectRenderTag } from 'naive-ui/es/tree-select/src/interface';
...
export declare const treeSelectProps: {
    ...
    readonly onUpdateIndeterminateKeys: PropType<MaybeArray<import("naive-ui/es/tree/src/Tree").OnUpdateIndeterminateKeys>>;
    readonly 'onUpdate:indeterminateKeys': PropType<MaybeArray<import("naive-ui/es/tree/src/Tree").OnUpdateIndeterminateKeys>>;
    readonly onUpdateExpandedKeys: PropType<MaybeArray<import("naive-ui/es/tree/src/Tree").onUpdateExpandedKeys>>;
    readonly 'onUpdate:expandedKeys': PropType<MaybeArray<import("naive-ui/es/tree/src/Tree").onUpdateExpandedKeys>>;
    readonly bordered: {

...
export declare const avatarGroupProps: {
    ...
    readonly theme: PropType<import("naive-ui/es/_mixins").Theme<"AvatarGroup", {
        gap: string;
    }, {
        Avatar: import("naive-ui/es/_mixins").Theme<"Avatar", {
            borderRadius: string;
            fontSize: string;
            border: string;
            heightTiny: string;
    ...
    readonly themeOverrides: PropType<import("naive-ui/es/_mixins/use-theme").ExtractThemeOverrides<import("naive-ui/es/_mixins").Theme<"AvatarGroup", {
        gap: string;
    }, {
        Avatar: import("naive-ui/es/_mixins").Theme<"Avatar", {
            borderRadius: string;
    ...
    readonly builtinThemeOverrides: PropType<import("naive-ui/es/_mixins/use-theme").ExtractThemeOverrides<import("naive-ui/es/_mixins").Theme<"AvatarGroup", {
        gap: string;
    }, {
        Avatar: import("naive-ui/es/_mixins").Theme<"Avatar", {
            borderRadius: string;

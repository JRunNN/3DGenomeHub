...
import type { CascaderOption, ExpandTrigger, Filter, OnLoad, OnUpdateValue, Value } from 'naive-ui/es/cascader/src/interface';
export declare const cascaderProps: {
    ...
    readonly theme: PropType<import("naive-ui/es/_mixins").Theme<"Cascader", {
    ...
    readonly themeOverrides: PropType<import("naive-ui/es/_mixins/use-theme").ExtractThemeOverrides<import("naive-ui/es/_mixins").Theme<"Cascader", {
        menuBorderRadius: string;
        menuColor: string;
        menuBoxShadow: string;
        menuDividerColor: string;
    ...
    readonly builtinThemeOverrides: PropType<import("naive-ui/es/_mixins/use-theme").ExtractThemeOverrides<import("naive-ui/es/_mixins").Theme<"Cascader", {
        menuBorderRadius: string;
        menuColor: string;
        menuBoxShadow: string;
        menuDividerColor: string;
...
declare const _default: import("vue").DefineComponent<{
    ...
    mergedValue: import("vue").ComputedRef<import("naive-ui/es/cascader/src/interface").ValueAtom | import("naive-ui/es/cascader/src/interface").ValueAtom[] | null>;
    ...
    blur: () => void;
    getCheckedData: () => {
        keys: import("naive-ui/es/cascader/src/interface").ValueAtom[];

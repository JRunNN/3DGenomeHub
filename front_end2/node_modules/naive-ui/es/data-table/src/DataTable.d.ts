...
declare const _default: import("vue").DefineComponent<{
    readonly onUnstableColumnResize: import("vue").PropType<(resizedWidth: number, limitedWidth: number, column: import("naive-ui/es/data-table/src/interface").TableBaseColumn<import("naive-ui/es/data-table/src/interface").InternalRowData>, getColumnWidth: (key: import("naive-ui/es/data-table/src/interface").ColumnKey) => number | undefined) => void>;
    readonly pagination: {
        readonly type: import("vue").PropType<false | import("naive-ui/es/pagination").PaginationProps>;
    ...
    readonly columns: {
        readonly type: import("vue").PropType<import("naive-ui/es/data-table/src/interface").TableColumns<any>>;
        readonly default: () => never[];
    };
    readonly rowClassName: import("vue").PropType<string | import("naive-ui/es/data-table/src/interface").CreateRowClassName<any>>;
    readonly rowProps: import("vue").PropType<import("naive-ui/es/data-table/src/interface").CreateRowProps<any>>;
    readonly rowKey: import("vue").PropType<import("naive-ui/es/data-table/src/interface").CreateRowKey<any>>;
    readonly summary: import("vue").PropType<import("naive-ui/es/data-table/src/interface").CreateSummary<any>>;
    readonly data: {
        readonly type: import("vue").PropType<import("naive-ui/es/data-table/src/interface").RowData[]>;
        readonly default: () => never[];
    };
    ...
    readonly renderCell: import("vue").PropType<(value: any, rowData: object, column: import("naive-ui/es/data-table/src/interface").TableBaseColumn<import("naive-ui/es/data-table/src/interface").InternalRowData>) => import("vue").VNodeChild>;
    readonly renderExpandIcon: import("vue").PropType<import("naive-ui/es/data-table/src/interface").RenderExpandIcon>;
    readonly spinProps: {
    ...
    readonly 'onUpdate:page': import("vue").PropType<import("naive-ui/es/_utils").MaybeArray<(page: number) => void> | undefined>;
    readonly onUpdatePage: import("vue").PropType<import("naive-ui/es/_utils").MaybeArray<(page: number) => void> | undefined>;
    readonly 'onUpdate:pageSize': import("vue").PropType<import("naive-ui/es/_utils").MaybeArray<(pageSize: number) => void> | undefined>;
    readonly onUpdatePageSize: import("vue").PropType<import("naive-ui/es/_utils").MaybeArray<(pageSize: number) => void> | undefined>;
    ...
    readonly onUpdateFilters: import("vue").PropType<import("naive-ui/es/_utils").MaybeArray<import("naive-ui/es/data-table/src/interface").OnUpdateFilters>>;
    readonly 'onUpdate:checkedRowKeys': import("vue").PropType<import("naive-ui/es/_utils").MaybeArray<import("naive-ui/es/data-table/src/interface").OnUpdateCheckedRowKeys>>;
    readonly onUpdateCheckedRowKeys: import("vue").PropType<import("naive-ui/es/_utils").MaybeArray<import("naive-ui/es/data-table/src/interface").OnUpdateCheckedRowKeys>>;
    ...
    readonly onPageChange: import("vue").PropType<import("naive-ui/es/_utils").MaybeArray<(page: number) => void> | undefined>;
    readonly onPageSizeChange: import("vue").PropType<import("naive-ui/es/_utils").MaybeArray<(pageSize: number) => void> | undefined>;
    ...
    readonly theme: import("vue").PropType<import("naive-ui/es/_mixins").Theme<"DataTable", {
    ...
    filter: (filters: import("naive-ui/es/data-table/src/interface").FilterState | null) => void;
    filters: (filters: import("naive-ui/es/data-table/src/interface").FilterState | null) => void;
    clearFilters: () => void;
    clearSorter: () => void;
    page: (page: number) => void;
    sort: (columnKey: import("naive-ui/es/data-table/src/interface").ColumnKey, order: import("naive-ui/es/data-table/src/interface").SortOrder) => void;
    ...
    mergedPagination: import("vue").ComputedRef<import("naive-ui/es/pagination").PaginationProps>;
    ...
    readonly data: import("naive-ui/es/data-table/src/interface").RowData[];
    ...
    readonly pagination: false | import("naive-ui/es/pagination").PaginationProps;

...
export declare const listProps: {
    ...
    theme: PropType<import("naive-ui/es/_mixins").Theme<"List", {
        textColor: string;
        color: string;
        colorHover: string;
        colorModal: string;
    ...
    themeOverrides: PropType<import("naive-ui/es/_mixins/use-theme").ExtractThemeOverrides<import("naive-ui/es/_mixins").Theme<"List", {
        textColor: string;
        color: string;
        colorHover: string;
        colorModal: string;
    ...
    builtinThemeOverrides: PropType<import("naive-ui/es/_mixins/use-theme").ExtractThemeOverrides<import("naive-ui/es/_mixins").Theme<"List", {
        textColor: string;
        color: string;
        colorHover: string;
        colorModal: string;

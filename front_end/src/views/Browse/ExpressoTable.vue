          ...
          { 
            ...
            action: () => {
              const trackData = {
                ...
                download_link: `https://3dgenomehub.oss-cn-shenzhen.aliyuncs.com/hic/${row.id}/${row.id}.compartments_E1.bigwig`
              };
          ...
          { 
            ...
            action: () => {
              const trackData = {
                ...
                download_link: `https://3dgenomehub.oss-cn-shenzhen.aliyuncs.com/hic/${row.id}/${row.id}.contact_domains.bed.gz`
              };
              emit('add-track', trackData);
            }
          },
          { 
            ...
            action: () => {
              const trackData = {
                ...
                download_link: `https://3dgenomehub.oss-cn-shenzhen.aliyuncs.com/hic/${row.id}/${row.id}.chromatin_loops.bed.gz`,
          ...
          { 
            ...
            action: () => {
              const trackData = {
                ...
                download_link: `https://3dgenomehub.oss-cn-shenzhen.aliyuncs.com/hic/${row.id}/${row.id}.matrix.gz`
              };
              emit('add-track', trackData);
            }
          }
          ...
          { 
            ...
            action: () => {
              const trackData = {
                ...
                download_link: `https://3dgenomehub.oss-cn-shenzhen.aliyuncs.com/hic/${row.id}/${row.id}.peaks.bed.gz`
              };
              emit('add-track', trackData);
            }
          },
...
const fnGetMenudata = () => {
  axios.get('http://47.107.91.5:8888/api/genomehub/samples/', {
    responseType: 'json',
  })
    .then(res => {

<template>
    <div class="track-item relative track-item-sortable mb-4 flex flex-col" ref="trackItem" :id="`${props.trackId}`">
        <div class="flex">
        ...
        <!-- track drag handler -->
        <div class="track-item-config-holder cursor-pointer bg-gray-300 rounded-r-lg relative w-6 flex-none flex flex-col justify-between items-center pt-1 pb-1"
            >
            <!-- close button -->
        ...
        <div ref="resizeHandler"
            class="ui-resizable-handle ui-resizable-s mt-2  w-full h-0.5  border-dashed border-t border-d border-gray-300 hover:border-blue-600 " >
        </div>
...
.track-item-config-holder .track-item-setting {
    display: none;
}
...
.track-item-config-holder:hover .track-item-setting {
    display: block;
}
